"""
Django settings for gest_locative project.
...
SECRET_KEY = 'django-insecure-dzgs)pt)aze^&z6+ia!9)&(0(=s%($vh3a=cqgy+lw17s%d1d+'
...
ROOT_URLCONF = 'gest_locative.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bailti.context_processors.user_role',
            ],
        },
    },
]

WSGI_APPLICATION = 'gest_locative.wsgi.application'
